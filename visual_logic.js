...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgba(255,255,255,0); width: 200; height: 50px; bottom: 20px; left: 50%; margin-left: -100px; background-size: 100%; cursor: pointer; outline: 0;", false, '');
...
setHTMLElemAttribute('href', 'https://yala.com', 'info_button', false);
...
operateAnimation('PLAY', 'yala_armature', 0, 180, 'LoopRepeat', 1, function() {}, false);

volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('yala_mesh', false, false, [0,1,2], false, function(event) {
    operateAnimation('STOP', 'yala_armature', null, null, 'AUTO', 1, function() {}, false);
    playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);
    operateAnimation('PLAY', 'yala_armature', 181, 275, 'LoopOnce', 1, function() {
        operateAnimation('PLAY', 'yala_armature', 0, 180, 'LoopRepeat', 1, function() {}, false);
    }, false);
}, function(event) {});
...
checkARMode(function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
        enterARMode('ORIGIN', true, function() {
            changeVis(['GROUP', 'yala_group'], false);
            ...
            changeVis(['GROUP', 'yala_group'], true);
            changeVis('prompt_move_around', false);
            setObjTransform('yala_armature', false, 'position', createVector(0, 0, 0), false);
            ...
            setObjTransform('yala_armature', false, 'scale', [1, 1, 1], false);
    ...
    setHTMLElemAttribute('href', exportToUSDZ('yala_mesh'), 'enter_AR_button', false);
    setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
    setHTMLElemAttribute('download', 'yala_usdz', 'enter_AR_button', false);
}, function() {
    eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], false, function(event) {
    changeVis(['GROUP', 'yala_group'], true);
    setObjTransform('yala_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
    setObjDirection('yala_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('yala_armature', 'XY', 'WORLD', '|,YN4b`htExAL4=Zlv4X', 'CSns0_isr5;KaA5dAbaP');
}, function(event) {}, 'CSns0_isr5;KaA5dAbaP');

registerOnDrag('drag_rotate', false, [0,1,2], function(event) {}, function(event) {
    dragRotateAdv('yala_armature', 'Z', 'WORLD', 'Hn0ay9H_)C%#2%dwkq$N', '#/8pwP/O]|u36@etB~Fc');
}, function(event) {}, '#/8pwP/O]|u36@etB~Fc');

registerOnDrag('drag_scale', false, [0,1,2], function(event) {}, function(event) {
    dragScale('yala_armature', 'Z', 'O;vU~||Ck0ae.exGE!EQ', '$kHz}{h9-W_W,gDH!ojR');
    dragScale('yala_armature', 'X', 'p~ecpr4sG2t/`NzmM+V{', '$kHz}{h9-W_W,gDH!ojR');
    dragScale('yala_armature', 'Y', '{J{{,%y+U1rPnE^YGM,E', '$kHz}{h9-W_W,gDH!ojR');
    updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('yala_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function(event) {}, '$kHz}{h9-W_W,gDH!ojR');
